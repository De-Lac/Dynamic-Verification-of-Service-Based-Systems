...
/**
 * This is the item provider adapter for a {@link unicam.workflowgraph.Action} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Action_successor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Action_successor_feature", "_UI_Action_type"),
				 WorkflowgraphPackage.Literals.ACTION__SUCCESSOR,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPredecessorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Action_predecessor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Action_predecessor_feature", "_UI_Action_type"),
				 WorkflowgraphPackage.Literals.ACTION__PREDECESSOR,
				 true,
				 false,
				 true,
				 null,
