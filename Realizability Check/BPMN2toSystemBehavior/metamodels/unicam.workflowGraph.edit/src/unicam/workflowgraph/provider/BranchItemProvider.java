...
/**
 * This is the item provider adapter for a {@link unicam.workflowgraph.Branch} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Branch_nodes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Branch_nodes_feature", "_UI_Branch_type"),
				 WorkflowgraphPackage.Literals.BRANCH__NODES,
				 true,
				 false,
				 true,
				 null,
