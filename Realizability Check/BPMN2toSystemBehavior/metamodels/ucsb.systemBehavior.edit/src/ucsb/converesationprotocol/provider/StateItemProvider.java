...
/**
 * This is the item provider adapter for a {@link ucsb.converesationprotocol.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConveresationprotocolPackage.Literals.STATE__OUTGOING,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConveresationprotocolPackage.Literals.STATE__INCOMING,
				 true,
				 false,
				 true,
				 null,
