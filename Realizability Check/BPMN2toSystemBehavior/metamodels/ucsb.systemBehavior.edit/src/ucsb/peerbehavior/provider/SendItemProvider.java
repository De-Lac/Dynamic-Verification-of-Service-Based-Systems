...
/**
 * This is the item provider adapter for a {@link ucsb.peerbehavior.Send} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SendItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Send_message_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Send_message_feature", "_UI_Send_type"),
				 PeerbehaviorPackage.Literals.SEND__MESSAGE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Send)object).getName();
