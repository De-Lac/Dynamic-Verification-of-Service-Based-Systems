 ...
 * @generated
 */
public class PeerbehaviorSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PeerbehaviorPackage.PEER: {
				Peer peer = (Peer)theEObject;
				T result = casePeer(peer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PeerbehaviorPackage.MESSAGE: {
				Message message = (Message)theEObject;
				T result = caseMessage(message);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PeerbehaviorPackage.STATE: {
				State state = (State)theEObject;
				T result = caseState(state);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PeerbehaviorPackage.TRANSITION: {
				Transition transition = (Transition)theEObject;
				T result = caseTransition(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PeerbehaviorPackage.SEND: {
			...
			case PeerbehaviorPackage.RECEIVE: {
			...
			case PeerbehaviorPackage.INPUT: {
			...
			case PeerbehaviorPackage.OUTPUT: {
			...
			case PeerbehaviorPackage.INTERNAL_TRANSITION: {
