...
//				 }
				...
				if (children.size() > 0 )
				{
					for (TreeNode child : children)
					{
						...
						for (TreeNode leaf : child.getLeaves())
						{
							...
							String str =level; printDebug(str+"\n"); for(ExtendedActivity ct : son.getCts()) {str +=(ct.getName()+" ");} 
	 ...
	 *     so I don't consider A ~> B, I remove A from AtIn[B]
	 ...
	 ArrayList<ArrayList<ExtendedActivity>> interleavings = generateAllInterleaving(list);
	...
	private void appendRemainingCts(TreeNode tn, String level) 
	{
	 ...
	 for(ExtendedActivity ct : child.getCts()) {str+=(ct.getName()+" ");} 
	 printDebug(str+"##\n");
	}
	...
	{
	 ArrayList<ExtendedActivity> currentTrace = new ArrayList<ExtendedActivity>();
	 ...
	 for (ExtendedActivity ct : currentTrace)
	 	{
...
private void brothersCreation(GraphNode gn, TreeNode tn, String level)
   ...
   */
	...
	public static void main(String[] args)
	{
		...
		pm.debug=true;
		ExtendedActivity uno;
		ExtendedActivity due;
		ExtendedActivity tre;
		ExtendedActivity quattro;
		ExtendedActivity cinque;
		ExtendedActivity sei;
//		ExtendedActivity sette;
//		ExtendedActivity otto;
//		ExtendedActivity nove;
		{
		 TParticipant sender = new TParticipant(); sender.setName("daniele");
		 TParticipant receiver = new TParticipant(); receiver.setName("michelle");
		 TChoreographyTask t = new TChoreographyTask(); t.setName("1"); t.setId("1");
		  uno = new ExtendedActivity(t, sender, receiver);
		}
		{
			 TParticipant sender = new TParticipant(); sender.setName("michelle");
			 TParticipant receiver = new TParticipant(); receiver.setName("daniele");
			 TChoreographyTask t = new TChoreographyTask(); t.setName("2");t.setId("2");
			 due = new ExtendedActivity(t, sender, receiver);
		}
		{
			 TParticipant sender = new TParticipant(); sender.setName("daniele");
			 TParticipant receiver = new TParticipant(); receiver.setName("philipp");
			 TChoreographyTask t = new TChoreographyTask(); t.setName("3");t.setId("3");
			 tre = new ExtendedActivity(t, sender, receiver);
		}
		{
			 TParticipant sender = new TParticipant(); sender.setName("philipp");
			 TParticipant receiver = new TParticipant(); receiver.setName("daniele");
			 TChoreographyTask t = new TChoreographyTask(); t.setName("4");t.setId("4");
			 quattro = new ExtendedActivity(t, sender, receiver);
		}
		{
			 TParticipant sender = new TParticipant(); sender.setName("philipp");
			 TParticipant receiver = new TParticipant(); receiver.setName("anna");
			 TChoreographyTask t = new TChoreographyTask(); t.setName("5");t.setId("5");
			 cinque = new ExtendedActivity(t, sender, receiver);
		}
		{
			 TParticipant sender = new TParticipant(); sender.setName("anna");
			 TParticipant receiver = new TParticipant(); receiver.setName("philipp");
			 TChoreographyTask t = new TChoreographyTask(); t.setName("6");t.setId("6");
			 sei = new ExtendedActivity(t, sender, receiver);
		}
//		{
//			 TParticipant sender = new TParticipant(); sender.setName("B");
//			 TParticipant receiver = new TParticipant(); receiver.setName("C");
//			 TChoreographyTask t = new TChoreographyTask(); t.setName("7");t.setId("7");
//			 sette = new ExtendedActivity(t, sender, receiver);
//		}
//		{
//			 TParticipant sender = new TParticipant(); sender.setName("C");
//			 TParticipant receiver = new TParticipant(); receiver.setName("D");
//			 TChoreographyTask t = new TChoreographyTask(); t.setName("8");t.setId("8");
//			 otto = new ExtendedActivity(t, sender, receiver);
//		}
//		{
//			 TParticipant sender = new TParticipant(); sender.setName("D");
//			 TParticipant receiver = new TParticipant(); receiver.setName("A");
//			 TChoreographyTask t = new TChoreographyTask(); t.setName("9");t.setId("9");
//			 nove = new ExtendedActivity(t, sender, receiver);
//		}
			
		
		// inserisco il primo CT di ogni ramo
		ArrayList<ExtendedActivity> cts = new ArrayList<ExtendedActivity>();
		cts.add(tre);
		cts.add(uno);
...
//		cts.add(sei);
		...
		wg.addControlFlow(sag, tre);wg.addControlFlow(tre, quattro);;wg.addControlFlow(quattro, cinque); ;wg.addControlFlow(cinque, sei);wg.addControlFlow(quattro, eag);
		wg.addControlFlow(sag, uno); ;wg.addControlFlow(uno, due);wg.addControlFlow(due, eag);
